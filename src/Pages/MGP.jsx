          ...
          return (
            <React.Fragment key={i}>
              <div className="flex flex-col items-start justify-center gap-5 mt-11 lg:gap-8 lg:flex-row">
                <img className="max-w-xs duration-500 ease-in-out cursor-pointer md:max-w-sm lg:max-w-lg hover:brightness-75" src={_.image} alt="" />
                <ul className="max-w-sm">
                  <h1 className="text-3xl font-bold md:text-4xl">
                    Save on 3 Groups
                  </h1>
                  <p className="mt-3.5 font-semibold text-gray-500">what will you get:</p>
                  {_.list.map((i) => {
