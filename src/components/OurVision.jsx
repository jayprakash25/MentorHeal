  ...
  return (
    ...
    <div >
      ...
      className="mt-8 font-medium  text-[13px] md:text-[16.5px] w-80 lg:text-[20px] lg:w-[562px] text-[#7C7C7C]  ">
        ...
        <p>
          We believe the world will look very different after this pandemic. as
          it did after the second world warand the financial crisis of 2008. As
          it always does,after it has faced destruction.{" "}
        </p>
        <p className="mt-4">
          We foresee a gigantic acceleration towards digitalisation in all
          businesses, Businesses need to vet partners, hold money in escrow.
        </p>
      </div>
    </div>
  );
