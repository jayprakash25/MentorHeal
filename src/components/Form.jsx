const Form = () => {
  return (
    <>
      <div className=" bg-[#ffffff]  text-gray-100 -my-20">
        ...
        <div className="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-white text-gray-900 rounded-lg ">
          ...
          <div>
            ...
            <div className="mt-8">
              <button className=" text-sm font-bold tracking-wide bg-indigo-500 text-gray-100 p-3 rounded-lg">
                Send Message
              </button>
            </div>
          </div>
