...
const AboutUs = () => {
  ...
  <div class=" mt-3  ">
    ...
    <div className='px-1 py-5  sm:ml-32 sm:mt-3 flex'>
      <button className=' ml-4 outline-double outline-1 bg-black text-white py-2 px-6 rounded-full font-bold transition duration-300 ease-in-out hover:bg-white hover:text-black sm:w-44 sm:h-14'>Get Started</button>
