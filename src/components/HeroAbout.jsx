      ...
      <div className="bg-gradient-to-r from-[#e8f4ef] to-[#faebe5]   mt-0   flex flex-col-reverse md:flex-row  items-center pt-14 ">
        <div className="flex flex-col items-center px-6 mx-auto">
          <div data-aos="zoom-in">
            <h1 className="font-semibold text-xl md:text-4xl lg:text-5xl leading-10 md:leading-[50px] lg:leading-[65px] lg:w-[573px] text-center py-4 md:pt-16">
              We heal the <span className="text-[#00b8d3]">modern</span> world
              with mentorship
            </h1>
          </div>
        </div>
